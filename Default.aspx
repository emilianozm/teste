...
<head id="Head1" runat="server">
   ...
   <noscript>
    <meta http-equiv="refresh" content="1; url=http://192.168.1.104/iis/semjava.html">
</noscript>
  
   <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0, user-scalable=no"/>
   <link rel="stylesheet" type="text/css" href="img/estilos/estilos.css" media="(min-width: 1024px)">
   <link rel="stylesheet" type="text/css" href="img/estilos/mobile.css" media="(max-width: 939px)">
...
M = ua.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*([\d\.]+)/i) || [];
   ...
   if (meta > 96) {
       ...
       $("#led").html($("<img>").attr("src", "img/green.jpg"));
   ...
   if (meta == 96) {
       ...
       $("#led").html($("<img>").attr("src", "img/yellow.jpg"));
   ...
   if (meta < 96) {
       ...
       $("#led").html($("<img>").attr("src", "img/red.jpg"));
